    ...
    <div id="mainContainer" class="container">
        ...
        <div class="row">
            <div class="col-md-5">
                ...
                <img src="<?php echo base_url('imagecontroller/show/'.$orderinfo['image']); ?>" class="product-image" alt="Product Image">
                    <div class="product-info">
                        <h3><?php echo isset($orderinfo['product_name']) ? $orderinfo['product_name'] : "Product Name"; ?></h3>
                        <ul class="info-list">
                            <li><i class="fas fa-box"></i> Order ID: <?php echo isset($orderinfo['order_id_for_users']) ? $orderinfo['order_id_for_users'] : "No data"; ?></li>
                            <li><i class="fas fa-tag"></i> Category: <?php echo isset($orderinfo['category']) ? $orderinfo['category'] : "No data"; ?></li>
                            <li><i class="fas fa-calendar"></i> Ordered on: <?php echo isset($orderinfo['order_date']) ? date('d M Y', strtotime($orderinfo['order_date'])) : "No data"; ?></li>
            ...
            <div class="col-md-7">
                            ...
                            <div class="feedback-item">
                                ...
                                <?php if(session()->get('id') == $feedback['user_id']): ?>
                                    <div class="feedback-actions">
                                        <button onclick="openDeleteModal('<?php echo $feedback['feedback_id']; ?>', '<?php echo $orderinfo['order_id']; ?>')" 
                ...
                <div class="rating-section">
                    ...
                    <form id="feedbackForm" method="post" action="/submitfeedback/<?php echo $orderinfo['order_id']; ?>">
